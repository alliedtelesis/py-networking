...
"""]
    ...
    dut.add_cmd({'cmd': 'show clock details'          , 'state':0, 'action':'PRINT','args': clock_output_0})
    ...
    dut.add_cmd({'cmd': 'show clock details'          , 'state':2, 'action':'PRINT','args': clock_output_1})
    ...
    dut.add_cmd({'cmd': 'show clock details'          , 'state':4, 'action':'PRINT','args': clock_output_2})
    ...
    dut.add_cmd({'cmd': 'show clock details'          , 'state':6, 'action':'PRINT','args': clock_output_3})
    ...
    dut.add_cmd({'cmd': 'show clock details'          , 'state':8, 'action':'PRINT','args': clock_output_4})
    ...
    dut.add_cmd({'cmd': 'show clock details'          , 'state':10,'action':'PRINT','args': clock_output_5})
