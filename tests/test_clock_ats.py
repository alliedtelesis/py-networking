...
"""]
    ...
    dut.add_cmd({'cmd': 'clock summer-time recurring 5 sun mar 2:00 5 sun oct 3:00 offset 60 zone CEST', 'state':1, 'action':'SET_STATE','args': [2]})
    ...
    dut.add_cmd({'cmd': 'clock summer-time recurring 1 sun oct 2:00 2 sun mar 2:00 offset 60 zone UYT' , 'state':3, 'action':'SET_STATE','args': [4]})
    ...
    dut.add_cmd({'cmd': 'clock summer-time recurring 1 sun oct 2:00 1 sun apr 3:00 offset 60 zone AEST', 'state':5, 'action':'SET_STATE','args': [6]})
    ...
    dut.add_cmd({'cmd': 'clock summer-time recurring 2 sun mar 2:00 1 sun nov 2:00 offset 60 zone EDT' , 'state':7, 'action':'SET_STATE','args': [8]})
