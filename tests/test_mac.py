...
"""]
    ...
    dut.add_cmd({'cmd': 'show mac address-table', 'state':3, 'action':'PRINT'    ,'args': output_1})
    dut.add_cmd({'cmd': update_cmd_1            , 'state':3, 'action':'SET_STATE','args':[4]})
    dut.add_cmd({'cmd': update_cmd_2            , 'state':4, 'action':'SET_STATE','args':[5]})
    dut.add_cmd({'cmd': update_cmd_3            , 'state':5, 'action':'SET_STATE','args':[6]})
    dut.add_cmd({'cmd': 'show mac address-table', 'state':6, 'action':'PRINT'    ,'args': output_2})
    dut.add_cmd({'cmd': delete_cmd_1            , 'state':6, 'action':'SET_STATE','args':[7]})
    dut.add_cmd({'cmd': delete_cmd_2            , 'state':7, 'action':'SET_STATE','args':[8]})
    dut.add_cmd({'cmd': delete_cmd_3            , 'state':8, 'action':'SET_STATE','args':[9]})
    dut.add_cmd({'cmd': 'show mac address-table', 'state':9, 'action':'PRINT'    ,'args': output_0})
